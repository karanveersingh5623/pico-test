...
class ConsumeFrames(Process):
    ...
    def run(self):
        ...
        processed_frame_producer = KafkaProducer(bootstrap_servers=["my-cluster-kafka-brokers:9092"],
...
class PredictFrames(Process):
    ...
    def run(self):
        ...
        #  Produces prediction object
        prediction_producer = KafkaProducer(bootstrap_servers=["my-cluster-kafka-brokers:9092"],
                                            key_serializer=lambda key: str(key).encode(),
                                            value_serializer=lambda value: json.dumps(value).encode())
        ...
        try:
            ...
            log_file.write('camera,frame,consumers\n')
            while True:
                ...
                for topic_partition, msgs in raw_frame_messages.items():
                    ...
                    for msg in msgs:
                        ...
                        print("frame_num: {},camera_num: {}".format(
                            result["frame_num"],
                            result["camera"]
                            #result["latency"],
                            #result["prediction"]
